...
<head>
	...
	<link href="web/css/stylesheet.css" rel="stylesheet" type="text/css" media="all">
	...
	<script src="web/js/custom_script.js"></script>
...
<div class="section clearfix section-colored7"><!--section start--> 
	...
	<div class="container"><!--container Start-->
		...
		<div class="Download_Cont_Top_Left left"><!--Download_Cont_Top Start-->
			<img src="web/images/icon5.png" alt=""> <h1 style="display:inline;">FREE: Men Are From Mars</h1> <a href="#">Download Now</a>
  ...
  <footer class="footer_wrapper">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Footer_Cont_Top clearfix"><!--Footer_Cont_Top Start-->
			...
			<span class="left"><img src="web/images/foot_logo.png" alt=""></span>
...
Live a life without regrets and take action today!</p>
		...
		<div class="Footer_Cont_Top2 clearfix"><!--Footer_Cont_Top2 Start-->
			...
			<h1>Call Us Today! (02) 9017 8413</h1>
			 <a href="#">Book an Appointment <img src="web/images/icon7.png" alt=""></a>
 			 <a href="#">Contact a Consultant <img src="web/images/icon6.png" alt=""></a>
